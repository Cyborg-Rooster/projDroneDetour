...
{
    public static string tutorial = "Passe por dentro das casas e evite colidir em paredes! se você subir demais, o drone desligará!";
    public static string dontDisplay = "Não exibir mais";

    public static string pressToStart = "Aperte em qualquer lugar para começar";

    public static string bestScore = "Melhor \n pontuação: ";
    ...
    public static string dev = "Desenvolvedor: /n - Enrisco";
    public static string music = "Músicas: /n - Umidori, /n - Everton Rodrigues, \n -Juhani Junkala";
    public static string distribution = "Distribuição: /n - Cyborg Rooster";
    ...
    public static void ChangeToEnglish()
    {
        ...
        dontDisplay = "Don't show more";

        pressToStart = "Press anywhere to start";
    ...
    public static void ChangeToPortuguese()
    {
        ...
        pressToStart = "Aperte em qualquer lugar para começar";
    ...
    public static void ChangeToSpanish()
    {
        ...
        pressToStart = "Apriete en cualquier lugar para empezar";
